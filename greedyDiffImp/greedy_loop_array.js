...
function greedy(num, den) {
    ...
    result = result.concat(greedyWhileLoop(num, den));
    console.log(result);
    //do while loops
    result = ["Do while loop"];
    result = result.concat(greedyDoWhileLoop(num, den));
    console.log(result);
    //for loops do not make sense
    result = ["For loop"];
    result = result.concat(greedyForLoop(num, den));
    console.log(result);
    return result;
}
...
/* uses while loop to get an array output for greedy method */
...
/* uses do while loop to get an array output for greedy method */
